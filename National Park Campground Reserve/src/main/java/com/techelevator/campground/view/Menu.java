...
public class Menu {
	...
	public void displayAvailableCampSites() {
		...
		List<Site> sites = siteDAO.getAllAvalableSites(selectedCampground.getCampgroundId(), startLocalDate, endLocalDate);
